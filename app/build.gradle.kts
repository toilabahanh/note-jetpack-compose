...
android {
    namespace = "com.bahanh.note"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.bahanh.note"
        minSdk = 33
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.ui:ui:$uiComposeVersion")
    implementation("androidx.compose.ui:ui-tooling:$uiComposeVersion")
    implementation("androidx.compose.ui:ui-geometry:$uiComposeVersion")
